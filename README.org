...
set ytics format "%.2f"
  ...
  file="./data/preciosBCSday.csv|./data/preciosBCSday.csv|./data/preciosBCSday.csv"

  #plot for [dataset in file] dataset using 1:3 with lines ls 1 title dataset
#+end_src
...
#+begin_src gnuplot :file "./fig/multiplot.png" :results file graphics :exports both
reset
load "set2.pal"
...
#+begin_src gnuplot :file "./fig/draft.png" :results file graphics :exports both
  ...
  set object 1 front lw 1 fc rgb "#0000ff" fs pattern 1 bo -1
  set object 2 ellipse at 0,0 size 2,2
  set object 2 front lw 1 fc rgb "#ff0000" fs pattern 1 bo -1

  plot "-" using 1:2 w lp title ""
  0 0
  0 0
#+end_src
